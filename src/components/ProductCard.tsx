    ...
    <div className={`rounded-lg overflow-hidden shadow-lg ${bgColor}`}>
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button onClick={() => addToCart(product)} className={`bg-green-500 hover:bg-green-600 text-white py-2 px-6 rounded-lg focus:outline-none transition duration-300 ease-in-out ${theme === 'light' ? 'hover:text-white' : 'hover:text-gray-900'}`}>Comprar</button>
        </div>
